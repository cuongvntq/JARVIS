...
class Conversation(Base):
    ...
    title: Mapped[str] = mapped_column(String(255), nullable=False, server_default="Cuộc hội thoại mới")
...
class Message(Base):
    ...
    metadata_: Mapped[dict] = mapped_column("metadata", JSON, nullable=False, server_default=sa.text("'{}'"))
